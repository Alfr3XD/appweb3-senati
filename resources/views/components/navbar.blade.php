                ...
                <div class="relative my-1 justify-self-center">
                    <form>
                        <div class="relative w-[550px]">
                            ...
                            <a href="#" class="duration-700 text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-[12px] px-4 py-2">
                                BUSCAR
                            </a>
                        </div>
                    </form> 
